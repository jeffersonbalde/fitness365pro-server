...
<head>
    ...
    <meta name="description" content="{{ $ogDescription ?? $shareText }}">

    @include('share._og-meta', [
        'ogTitle' => $ogTitle ?? $badgeTitle,
        'ogDescription' => $ogDescription ?? $shareText,
        'canonicalUrl' => $canonicalUrl,
        'imageUrl' => $imageUrl,
        'ogImageAlt' => $ogImageAlt ?? ($badgeTitle.' achievement'),
